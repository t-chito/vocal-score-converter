...
echo "----- validate files -----"
mfa validate ${CORPUS_DIRECTORY} english_us_arpa english_us_arpa --single_speaker --beam 100 --retry_beam 400 --verbose --num_jobs 1 --use_postgres # --temporary_directory  ${CORPUS_DIRECTORY}/temp --no_final_clean
...
echo "----- align -----"
mfa align ${CORPUS_DIRECTORY} english_us_arpa english_us_arpa ${CORPUS_DIRECTORY} --single_speaker --beam 100 --retry_beam 400 --verbose --num_jobs 1 --use_postgres